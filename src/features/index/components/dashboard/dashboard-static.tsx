...
export default function Dashboard() {
  ...
  return (
    <div className="text-[#213857] text-center">
      ...
      <h1 className="font-pinyonScript text-2 text-7xl xs:text-8xl -mt-1 mb-72 ms-32">Nafia</h1>
      ...
      <p className="font-meieScript text-sm px-6 mb-4">And of His signs is that He created for you from yourselves mates that you may find tranquility in them; and He placed between you affection and mercy. Indeed in that are signs for a people who give thought</p>
      <p className="font-merriweather text-sm italic">QS. Ar-Rum: 21</p>
    </div>
  );
}
