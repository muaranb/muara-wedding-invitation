...
export default function Home() {
	...
	useGSAP(() => {
		const ctx = gsap.context(() => {
			...
			.fromTo('#dashboard', 
				{ opacity: 0, },
				{ opacity: 1, ease: "sine.out", duration: 0.3 }
			)
			...
			.fromTo('#bridal_photo .button-1', 
				...
				{ scale: 1, translateY: 0, ease: "power1.inOut", duration: 0.3 },
				'<'
			)
			...
			.fromTo('#map .card', 
				...
				{ translateY: 0, ease: "power1.inOut", duration: 0.3 },
				'-=0.5'
			)
	...
	return (
		<main className="relative min-h-screen max-w-[440px] overflow-x-hidden mx-auto bg-white">
			...
			<section id="bridal_photo" className="relative min-h-screen w-full bg-[url(/backgrounds/bridal-photo.webp)] bg-cover bg-center flex flex-col items-center justify-center text-center overflow-hidden">
			...
			<section id="reception_date" className="relative min-h-screen w-full bg-[url(/backgrounds/reception-date.webp)] bg-cover bg-center flex flex-col items-center justify-center text-center px-20 text-[#213857]">
			...
			<section id="map" className="relative min-h-screen w-full bg-[url(/backgrounds/map.webp)] bg-cover bg-center flex flex-col items-center justify-center text-center overflow-hidden px-8 xs:px-10">
			...
			<section id="greetings" className="relative min-h-screen w-full bg-[url(/backgrounds/greetings.webp)] bg-cover bg-center flex flex-col items-center justify-center text-center overflow-hidden px-6">
			...
			<section id="gift" className="relative min-h-screen w-full bg-[url(/backgrounds/gift.webp)] bg-cover bg-center flex flex-col items-center justify-center text-center overflow-hidden px-6">
